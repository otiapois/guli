//package com.fouo.gateway.props;
//
...
//
//public class FouoProperties implements EnvironmentAware, EnvironmentCapable {
//    @Nullable
//    private Environment environment;
//
//    /**
//     * 装载自定义配置thingsgrid.prop.xxx
//     */
//    @Getter
...
//        String env = environment.getProperty("fouo.env");
//        return env;
//    }
//
//    /**
...
//        Objects.requireNonNull(environment, "Spring boot 环境下 Environment 不可能为null");
//        return environment.getProperty("spring.application.name", environment.getProperty("fouo.name", ""));
//    }
//
//    @Override
