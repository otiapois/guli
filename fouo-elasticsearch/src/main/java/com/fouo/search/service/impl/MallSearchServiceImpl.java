...
import com.fouo.search.mapper.MallSearchMapper;
...
@Service
public class MallSearchServiceImpl extends ServiceImpl<MallSearchMapper, SearchParam> implements IMallSearchService {
...
//            List<String> list = Arrays.asList(attrValues.get(0).split(";"));
